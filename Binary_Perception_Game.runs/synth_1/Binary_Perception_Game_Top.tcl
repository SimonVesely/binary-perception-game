...
synth_design -top Binary_Perception_Game_Top -part xc7a50ticsg324-1L
...
write_checkpoint -force -noxdef Binary_Perception_Game_Top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file Binary_Perception_Game_Top_utilization_synth.rpt -pb Binary_Perception_Game_Top_utilization_synth.pb"  } 
